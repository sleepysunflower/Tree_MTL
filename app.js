document.addEventListener('DOMContentLoaded', async () => {
  ...
  // ---------------- Data URLs ----------------
  const URLS = {
    trees:   'https://github.com/sleepysunflower/Tree_MTL/releases/download/data/trees.geojson',
    fellings:'https://github.com/sleepysunflower/Tree_MTL/releases/download/data/fellings.geojson',
    nbhd:    'https://github.com/sleepysunflower/Tree_MTL/releases/download/data/nbhd_stats.geojson'
  };
